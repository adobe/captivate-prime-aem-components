...
public class EmbeddableWidgetsConfigTest
{
  ...
  public void testGeneralSettingsConfig()
  {
    ...
    assertTrue(generalConfig.getName().equals("General Settings"));
    assertTrue(generalConfig.getRef().equals("com.adobe.captivateprime"));
    assertTrue(generalConfig.getWidgetRef().equals("com.adobe.captivateprime.widgetRef"));
    assertTrue(generalConfig.getDescription().equals("These are all the common settings applicable for all the widgets"));
    assertTrue(generalConfig.getType().equals("general"));
    assertTrue(generalConfig.getOptions().size() > 0);
  }
